...
namespace FIT_Api_Examples.Modul1_TestniPodaci.Controllers
{
    ...
    public class TestniPodaciController : ControllerBase
    {
        ...
        public ActionResult Generisi()
        {
            ...
            nastavnici.Add(new Nastavnik {email = "adil@edu.fit.ba", ime = "Denis", prezime = "Music", korisnickoIme = "denis", lozinka = "test", isAktiviran = true});
            nastavnici.Add(new Nastavnik {email = "adil@edu.fit.ba",  ime = "Emina", prezime = "Junuz", korisnickoIme = "emina", lozinka = "test",  });
            nastavnici.Add(new Nastavnik {email = "adil@edu.fit.ba",  ime = "Iris", prezime = "Memic-Fisic", korisnickoIme = "iris", lozinka = "test",  isProdekan=true });
            nastavnici.Add(new Nastavnik {email = "adil@edu.fit.ba",  ime = "Nina", prezime = "Bijedic", korisnickoIme = "nina", lozinka = "test",  isDekan = true });
            nastavnici.Add(new Nastavnik { email = "adil@edu.fit.ba", ime = "Adil", prezime = "Joldic", korisnickoIme = "adil", lozinka = "test",  isAdmin=true });
